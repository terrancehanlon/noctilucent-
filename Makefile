all:    
	...
	g++ target/Animation.o target/AnimatedSprite.o target/Player.o target/main.o target/level.o target/levelManager.o target/levelOne.o target/levelTwo.o -o mainp -lsfml-graphics -lsfml-window -lsfml-system;
