all:    
	...
	g++ target/Animation.o target/AnimatedSprite.o target/Player.o target/Dummy.o target/HoodedOccult.o target/main.o target/level.o target/levelManager.o target/levelOne.o target/levelTwo.o target/texuremanager.o -o mainp -lcurl -lsfml-graphics -lsfml-window -lsfml-system;
